...
def html5_parse_simple_color(input: str) -> HTML5SimpleColor:
    ...
    if not input.startswith("#"):
        raise ValueError(
            u"An HTML5 simple color must begin with the " u"character '#' (U+0023)."
        )
...
def html5_parse_legacy_color(input: str) -> HTML5SimpleColor:
    ...
    if input == "":
        raise ValueError(u"HTML5 legacy color parsing forbids empty string as a value.")
    ...
    while (length > 2) and (red[0] == u"0" and green[0] == u"0" and blue[0] == u"0"):
